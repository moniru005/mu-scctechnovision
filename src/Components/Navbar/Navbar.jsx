...
const Navbar = () => {
  ...
  const loginButton = (
    <>
      <Link to='login'>
        <button
          className="middle none center hidden rounded-lg bg-gradient-to-tr from-[#0064A5] to-black py-2 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
          type="button"
        ...
        <div>
          ...
          <div className={`container mx-auto pb-2 `}>
            ...
            >
              ...
              <Link to="/login">
                <button
                  className="middle none center rounded-lg bg-gradient-to-tr from-[#0064A5] to-black py-2 mt-10 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
                  type="button"
                  data-ripple-light="true"
                >
                  <span>Login</span>
